    ...
    if ($().DataTable) {
      ...
      var $dataTableRows = $("#datatableRows").DataTable({
        ...
        buttons: [
            {
                ...
                title: function(){
                    var d = new Date();
                    return 'AMS-' + d.getDate() + '-' + d.getDay() + '-' + d.getFullYear();
                }
            }
        ],
        destroy: true,
        ...
        drawCallback: function () {
          ...
          $("#pageCountDatatable span").html("عرض " + parseInt(api.page.info().start + 1) + "-" + api.page.info().end + " من " + api.page.info().recordsTotal + " مادة");
        }
      });
